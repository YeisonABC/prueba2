<%-- 
    ...
    Created on : 30/12/2019, 05:07:53 PM
    ...
    <body>
        ...
        <div class="paneldDerecho">
            ...
            <%
                ...
                int codigoCargo = Integer.parseInt(request.getParameter("codigo"));
                sesion.setAttribute("codigoCargo", codigoCargo);
            %>
            <div class="formularioCliente">
                <form action="controladorEditarCargo">
