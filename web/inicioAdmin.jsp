...
<html>
    ...
    <body>
        ...
        <div class="p-3 panelIzquierdo">
            <div class="headLogo">
                <img src="META-INF/logoFramFree.jpg" >
            </div>
            <div class="contenidoPanelIzquierdo mt-4">
                <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">                      
                        <div class="botones mt-3 ml-4"><a href="listaPersonaCliente.jsp" >Lista Cliente</a></div>
                        <div class="botones mt-3 ml-4"><a href="listaPersona.jsp" >Lista Empleado</a></div>
                        <div class="botones mt-3 ml-4"><a href="listaPersona.jsp" >Lista Proveedores</a></div>
                        <div class="botones mt-3 ml-4"><a href="insertPersona.jsp">¿Nuevo tipo de Persona?</a></div>
                    </div>
        ...
        <div class="paneldDerecho">
            <div class="headBarra p-3">
                <div class="justify-content-end d-flex">
                    <div><a href="tiendaOnline.jsp">Tienda</a></div> &nbsp;
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Tu Cuenta
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <p class="text-center"><%=usuario%></p><br>
                            <hr>
