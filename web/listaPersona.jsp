    ...
    <body>
      ...
      <div class="paneldDerecho">
            ...
            <%
                ...
                List<Persona> lista = persona.leer();
            %>
            <div class="">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>                  
                            ...
                            <td><%                    out.println(Persona.getNombres());

                                %>
                            </td>
                            <td><%                    out.println(Persona.getApellidos());

                                %>
                            </td>
                            <td><%                    out.println(Persona.getRazonSocial());
                            ...
                            <td><%                    out.println(Persona.getTipoIdentificacion());
                            ...
                            <%--<td>
                                <a href="updatePersonaEmpleado.jsp?codigo=<%=Persona.getIdPersona()%>&&nombreCargo=<%=Persona.getNombreCargo()%>&&codigoCargo=<%=Persona.getCodigoCargo()%>&&nombre=<%=Persona.getNombrePersona()%>&&apellido=<%=Persona.getApellido()%>&&genero=<%=Persona.getGenero()%>&&cedula=<%=Persona.getCedula()%>&&fecha=<%=Persona.getFechaVinculacion()%>&&telefono=<%=Persona.getTelefono()%>&&tPersona=<%=Persona.getTipoPersona()%>"><i class="fas fa-pencil-alt"></i>
                                </a>
                            </td>
                            <td>
