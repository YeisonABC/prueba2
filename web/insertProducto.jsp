        ...
        <div class="paneldDerecho">
            ...
            <div class="formularioCliente">
                <form action="controladorEditaProducto" method="Get">
                    <label>Codigo Estante</label><input type="number" name="estante"><br>
                    <label>Codigo Produccion</label><input type="number" name="produccion"><br>
                    <label>Nombre</label><input type="text" name="nombre"><br>
                    <label>Precio</label><input type="number" name="precio"><br>
                    <label>Unidad Medida</label><input type="text" name="medida"><br>
